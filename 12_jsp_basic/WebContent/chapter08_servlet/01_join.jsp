...
<body>
	...
	<!-- 
		...
		- 서블릿이란 자바를 사용하여 웹을 만들기 위해 필요한 기술(=class)이름이다.
		...
		- java에서 수정했을 경우, 재시작을 해야 내용 변경이 된다. 
		  하지만 Project - Build Automatically 설정을 했기때문에 자동으로 변경된다 .
			
	 -->
	
	<div align="center">
		<h2>회원가입</h2>
		<form method="post" action="Join">		<!-- action에 jsp파일이름이 아닌 서블릿의 요청 URL을 입력한다. -->
			<table border="1">
				<tr>
					<th>아이디</th>
